...
import model.dashboardFormat.UserTopN;
...
public class UserCount10min10s extends StreamsForDashboard {
  ...
  final static Logger logger = LoggerFactory.getLogger(UserCount10min10s.class.getName());
  ...
  protected void setTopology(StreamsBuilder builder) {
    ...
    getIngestionTweetStream(builder)
        ...
        .mapValues((key, value) -> value.get("ScreenName").toString())
        ...
        .toStream()
        .mapValues((key, value) -> new UserTopN(value))
