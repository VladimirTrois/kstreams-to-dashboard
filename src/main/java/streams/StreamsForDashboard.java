...
public abstract class StreamsForDashboard implements Startable
{
    ...
    protected static KafkaStreams mainStream;
    ...
    public StreamsForDashboard()
    {
        Properties streamsConfiguration = getStreamsConfiguration();
        StreamsBuilder builder = new StreamsBuilder();
        setTopology(builder);
        this.mainStream = new KafkaStreams(builder.build(), streamsConfiguration);
    }

    public void start()
    {
        this.mainStream.cleanUp();
        this.mainStream.start();
