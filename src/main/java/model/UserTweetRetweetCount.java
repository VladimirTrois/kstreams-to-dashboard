...
public class UserTweetRetweetCount implements Serializable {
  ...
  public UserTweetRetweetCount addTweetStatus(GenericRecord tweetStatus) {
  ...
  @JsonCreator public UserTweetRetweetCount(
